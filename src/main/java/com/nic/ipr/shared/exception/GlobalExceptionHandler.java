...
@SuppressWarnings("unused") // Tells IntelliJ: "Trust me, Spring Boot calls these behind the scenes!"
public class GlobalExceptionHandler {
    ...
    // Removed the 'ex' parameter from these methods since we use hardcoded messages!
